...
\includegraphics[width = 4.0in]{_generated/hyperbolaFamily.pdf}
...
\includegraphics[width = 4.0in]{_generated/hyperbolaEnvelope.pdf}
...
\input{multiVarDiffCalc/threeStepMarkov.tex}
